...
class AmongUsMod(loader.Module):
	...
	async def sayliecmd(self, message):
		clrs = {'recep': 1, 'recep': 2, 'recep': 3, 'recep': 4, 'recep': 5, 'recep': 6, 'recep': 7, 'recep': 8, 'recep': 9, 'recep': 10, 'recep': 11, 'recep': 12, 'recep': 13, 'recep': 14}
		...
		url = "https://raw.githubusercontent.com/Selfuucuk/ri/main/"
